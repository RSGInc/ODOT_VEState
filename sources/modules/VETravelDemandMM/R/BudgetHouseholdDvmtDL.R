#=====================
#BudgetHouseholdDvmtDL.R
#=====================

#<doc>
#
## BudgetHouseholdDvmtDL Module
#### June 5, 2020
#
...
#' }
#' @source BudgetHouseholdDvmtDL.R script.
"OpPropModel_ls"
...
#------------------------------
BudgetHouseholdDvmtDLSpecifications <- list(
...
#---------------------------------
#' Specifications list for BudgetHouseholdDvmtDL module
#'
#' A list containing specifications for the BudgetHouseholdDvmtDL module.
#'
...
#' }
#' @source BudgetHouseholdDvmtDL.R script.
"BudgetHouseholdDvmtDLSpecifications"
visioneval::savePackageDataset(BudgetHouseholdDvmtDLSpecifications, overwrite = TRUE)
...
#'
#' \code{BudgetHouseholdDvmtDL} calculate the average household DVMT, adjusts it
...
#' @name BudgetHouseholdDvmtDL
#' @import visioneval
#' @export
BudgetHouseholdDvmtDL <- function(L, M) {
  #Setup
  #-----
  ...
  AltTrips_ls <- lapply(AltTrips_ls, unname)
...
#----------------------------------
documentModule("BudgetHouseholdDvmtDL")
...
# #Run test module
# TestDat_ <- testModule(
#   ModuleName = "BudgetHouseholdDvmtDL",
#   LoadDatastore = TRUE,
#   SaveDatastore = TRUE,
#   DoRun = FALSE,
...
# L <- TestDat_$L
# M <- TestDat_$M
# R <- BudgetHouseholdDvmtDL(TestDat_$L, TestDat_$M)
#
# TestDat_ <- testModule(
#   ModuleName = "BudgetHouseholdDvmtDL",
#   LoadDatastore = TRUE,
