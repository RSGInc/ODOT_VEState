...
|ShdCarSvcDeadheadFactor   |double   |multiplier |NA, < 0      |            |> 3      |The deadhead factor for shared car service calculated using deadhead mileage divided by fare mileage                                                                                               |
|UnShdCarSvcDeadheadFactor |double   |multiplier |NA, < 0      |            |> 3      |The deadhead factor for unshared car service calculated using deadhead mileage divided by fare mileage                                                                                             |
